...
#define LOG_FLAG_METHOD_ENTRY (1 << 4)
//0...1000 程序入口
...
#define LOG_LEVEL_METHOD_ENTRY (LOG_FLAG_ERROR | LOG_FLAG_WARN | LOG_FLAG_INFO | LOG_FLAG_VERBOSE | LOG_FLAG_METHOD_ENTRY)
//0...11111
...
#define LOG_ASYNC_WARN    ( NO && LOG_ASYNC_ENABLED)
#define LOG_ASYNC_INFO    ( NO && LOG_ASYNC_ENABLED)
...
#define DDMethodEntry	DDLogMethodEntry(@" Enter")
#define DDMethodLeave	DDLogMethodEntry(@" Leave")
#define DDLogMethodEntry(frmt, ...) LOG_OBJC_MAYBE(LOG_ASYNC_VERBOSE, ddLogLevel, LOG_FLAG_METHOD_ENTRY, 0, frmt, ##__VA_ARGS__)
...
#define DDLogCMethodEntry(frmt, ...) LOG_C_MAYBE(LOG_ASYNC_VERBOSE, ddLogLevel, LOG_FLAG_METHOD_ENTRY, 0, frmt, ##__VA_ARGS__)

static const int ddLogLevel = LOG_LEVEL_METHOD_ENTRY;
