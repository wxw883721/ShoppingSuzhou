...
{
    /** 设置星星的图片、大小、位置*/
    backgroundImageView=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"backgroundStar"]];
    backgroundImageView.frame=CGRectMake(0, 0, 65, 23);
    backgroundImageView.contentMode=UIViewContentModeLeft;
    foregroundImageView=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"foregroundStar"]];
