...
//    NSLog(@"*********%@",dic);
    ...
    _shoppingStoreName.font = [UIFont systemFontOfSize:Text_Big];
    ...
    [_shoppingImage sd_setImageWithURL:[NSURL URLWithString:[dic valueForKey:@"goods_image"]] placeholderImage:[UIImage imageNamed:@"200-200.png"]];
    
    [self addSubview:_shoppingImage];
    
    _shoppingShopName = [[UILabel alloc]initWithFrame:CGRectMake(128, 50, 120 *kScr_Rate, 21)];
    _shoppingShopName.font = [UIFont systemFontOfSize:Text_Big];
    ...
    _shoppingNum.font = [UIFont systemFontOfSize:Text_Big];
    ...
    _shoppingPrice.font = [UIFont systemFontOfSize:Text_Normal];
    ...
    _shoppingEditor.titleLabel.font = [UIFont systemFontOfSize:Text_Big];
    ...
    _shoppingTotalNum.font = [UIFont systemFontOfSize:Text_Big];
    ...
    _shoppingTotalPrice.font = [UIFont systemFontOfSize:Text_Big];
    ...
    _shoppingAddNumLabel.font = [UIFont systemFontOfSize: Text_Small];
